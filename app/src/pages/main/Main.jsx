...
const Main = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      if (role === "admin") {
        openAdminNotification("topLeft");
      } else if (role === "user") {
        openUserNotification("topLeft");
      }
    }, 500);
  }, []);
  return (
      ...
      <div className={style.container}>
        <section className={style.section}>
          ...
          <p className={style.sectionText}>
            ...
            mollitia error soluta hic. Hic rem aperiam nam! Similique nobis,
            aliquid quis temporibus neque quidem sint maiores eaque impedit
            nemo, iste accusantium, suscipit mollitia repellat vel beatae
            ratione. Quasi quis maxime cumque laborum quas, placeat maiores
            animi nesciunt, eos dicta beatae porro sed recusandae nostrum magni
            ad consequuntur quam laboriosam magnam labore autem id consectetur.
            Officiis, ea vero. Ipsam itaque qui exercitationem sequi voluptas
            nihil provident. Optio maxime dolorum quos corporis delectus
            doloribus perferendis voluptatibus quisquam qui officiis ab nemo
            repudiandae excepturi ullam aliquid consequatur nisi, id asperiores.
            Fugiat perferendis nesciunt laboriosam repellat aperiam culpa neque
            expedita molestias ullam soluta inventore incidunt delectus vitae
            voluptatibus suscipit, at dicta! Aspernatur, nulla suscipit?
          </p>
        </section>
        <section className={style.section}>
          ...
          <div className={style.tasks}>
            <div className={style.task}>
              ...
              <div className={style.taskDescription}>
                Созданию доступных интерфейсов
              </div>
            </div>
            <div className={style.task}>
